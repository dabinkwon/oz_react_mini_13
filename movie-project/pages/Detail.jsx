...
export default function Detail() {
  ...
  // const selectedMovie = movieData.find(el=>el.id === Number(movieId))

  // if(!selectedMovie)return <p>영화를 찾을 수 없습니다.</p>;
...
>
  ...
  <div className="flex flex-col items-center justify-center gap-6 p-7 bg-gray-500/50 rounded-xl">
    ...
    <p>{genre}</p>
    <p className="text-white max-w-[70vw] text-center">{movieDetailData.overview}</p>
  </div>
</div>
  );
}
